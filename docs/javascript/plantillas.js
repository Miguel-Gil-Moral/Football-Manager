document.addEventListener("DOMContentLoaded", function () {
    ...
    botonPlantilla.addEventListener("click", function () {
        if (botonPlantilla.textContent == "Ver plantilla femenino") {
            botonPlantilla.textContent = "Ver plantilla masculino";
            extraerPlantillaFemenina("plantillaMasculino");
        } else {
            botonPlantilla.textContent = "Ver plantilla femenino";
            extraerPlantillaMasculina("plantillaFemenino");
        }
    });

    function extraerPlantillaMasculina(idPlantilla) {
        fetch("./json/jugadors.json")
            ...
            .then(function (jugadores) {
                let contenedor = document.getElementById(idPlantilla);
                ...
                contenedor.id = "plantillaMasculino";
            })
    ...
    function extraerPlantillaFemenina(idPlantilla) {
        fetch("./FM_LligaFemenina_2025/jugadores.json")
            ...
            .then(function (jugadoras) {
                ...
                contenedor.id = "plantillaFemenino";
            })
            .catch(function (error) {
                console.error("Esto es un error: ", error);
            });
